...
**Live:** https://dirac1974.github.io/shockmate/ — marker `v0.20 · 152 fights · 32 days`.
...
3. **Play mode shipped v0.20.** Watch: does a game vs Rookie end inside 10 minutes; does the post-game "moment it turned" fight land; does either kid pick Marshal to show off and bounce off it (that is fine, nothing locks). Voice for Glitch's in-game lines is the obvious next add.
